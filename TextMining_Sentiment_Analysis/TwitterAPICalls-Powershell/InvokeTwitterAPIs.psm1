<#	
	===========================================================================
     ...
     Ref Link: https://gallery.technet.microsoft.com/scriptcenter/InvokeTwitterAPIs-84cf88a3
                ...
                while($true)
                {
                  ...
                  try
                  {
                    ...
                    while ($true) 
                    {
                            ...
                            if($Line -eq '') 
                            { continue }
                            $Line  #Return the line to calling client seperate to storing the result.Client may decide how to use it
